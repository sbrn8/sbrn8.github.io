...
const experiences = [
    {
      heading: "Co-president (Former VP of Events/Outreach)",
    ...
    {
      heading: "Undergraduate Research Assistant",
      subheading: "University of Waterloo",
      date: "2023/09 - 2024/04",
      description: "Conducted research on human-computer interaction, assisted in data collection and analysis, and co-authored a paper published in a peer-reviewed conference.",
